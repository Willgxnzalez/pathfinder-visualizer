...
export default function GridView({ grid, onDrawingChange }: GridViewProps) {
    ...
    return (
        <div className="absolute top-0 left-1/2 -translate-x-1/2 z-0 flex justify-center items-center grid-background relative select-none cursor-crosshair touch-none"
            ref={containerRef}
            onMouseDown={(e) => {
